...
export default function ProductWidget({name, image, id, isOwned = false, isAdmin= false}:ProductWidgetProps){//TODO add to cart products
    ...
    return (
        <section className='product-widget'>
            ...
            {!isOwned && <button className="cart-btn" type='button' onClick={()=>cartApi.addToCart({id:id, quantity:1})}>Add to Cart</button>}
